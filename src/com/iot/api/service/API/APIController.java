...
public class APIController {
    ...
    String postPoint(@RequestParam String dbName, @RequestParam String SecurityKey, @RequestParam double[] params) {
        ...
        if (contains){
            ...
            //fonction permettant d'écrire le point en mettant les valeurs pour chaque field
    ...
    String createChannel(String name, String key){ // Si on veut utiliser sa propre clé de sécurité
